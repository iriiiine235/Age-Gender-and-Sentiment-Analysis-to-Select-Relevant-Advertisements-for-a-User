...
Datadirectory= r"C:\\Users\\Work\\.vscode\\Age-Gender-and-Sentiment-Analysis-to-Select-Relevant-Advertisements-for-a-User\\Datasets\\gender_dataset"
print(Datadirectory)
...
mobilenetv2_model.add(Dense(2, activation="sigmoid"))
...
mobilenetv2_model.save('gender_model_mobilenetV2.h5')
flg1 = plt.gcf()
plt.plot(history.history["accuracy"])
plt.plot(history.history["val_accuracy"])
plt.axis(ymin=0.4,ymax=1)
plt.grid()
plt.title("MobileNetV2 Model Accuracy - gender")
plt.ylabel("Accuracy")
plt.xlabel("Epochs")
...
plt.grid()
plt.title("MobileNetV2 Model Loss - gender")
plt.ylabel("Loss")
plt.xlabel("Epochs")
plt.legend(["train","validation"])
plt.show()
...
#Test the model
my_model = load_model('gender_model_mobilenetV2.h5', compile=False)
