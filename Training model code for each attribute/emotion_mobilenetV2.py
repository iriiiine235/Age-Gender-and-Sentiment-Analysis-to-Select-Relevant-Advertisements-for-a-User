...
mobilenetv2_model.add(Dense(7, activation="sigmoid"))
...
plt.grid()
plt.title("MobileNetV2 Model Accuracy - Emotion")
plt.ylabel("Accuracy")
plt.xlabel("Epochs")
...
plt.grid()
plt.title("MobileNetV2 Model Loss - emotion")
plt.ylabel("Loss")
plt.xlabel("Epochs")
plt.legend(["train","validation"])
plt.show()
...
#Test the model
my_model = load_model('emotion_model_mobilenetV2.h5', compile=False)
