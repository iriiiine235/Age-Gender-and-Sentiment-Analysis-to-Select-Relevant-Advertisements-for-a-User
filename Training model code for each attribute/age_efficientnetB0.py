...
efficientnet_model.add(Dense(8, activation="sigmoid"))
...
efficientnet_model.save('age_model_efficientnetB0.h5')
flg1 = plt.gcf()
plt.plot(history.history["accuracy"])
plt.plot(history.history["val_accuracy"])
plt.axis(ymin=0.4,ymax=1)
plt.grid()
plt.title("EfficientNetB0 Model Accuracy - Age")
plt.ylabel("Accuracy")
plt.xlabel("Epochs")
...
plt.grid()
plt.title("EfficientNetB0 Model Loss - Age")
plt.ylabel("Loss")
plt.xlabel("Epochs")
plt.legend(["train","validation"])
plt.show()
...
#Test the model
my_model = load_model('age_model_efficientnetB0.h5', compile=False)
