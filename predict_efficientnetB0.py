...
import pandas as pd
import webbrowser
emotion_model= tf.keras.models.load_model("emotion_model_efficientnetB0.h5")
gender_model= tf.keras.models.load_model("gender_model_efficientnetB0.h5")
age_model= tf.keras.models.load_model("age_model_efficientnetB0.h5")
import cv2
